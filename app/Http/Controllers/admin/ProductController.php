 ...
 if(!empty($request->sizes)){
        ...
        if (!empty($request->gallery)) {
            foreach ($request->gallery as $key => $tempImageId) {
                ...
                $img->scaleDown(1200);
                $img->toJpeg()->save(public_path('uploads/products/large/' . $imageName));
                ...
                $img->toJpeg()->save(public_path('uploads/products/small/' . $imageName));
...
$productSizes = $product->product_sizes()->pluck('size_id');
    ...
    public function saveProductImage(Request $request)
    {
        ...
        $imageName = $request->product_id . '-' . time() . '.' . $image->extension(); //3245666.jpg
